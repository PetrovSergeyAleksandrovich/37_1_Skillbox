//
// Created by Poizone on 10.01.2022.
//

#ifndef INC_37_1_SKILLBOX_CALLERMAINWINDOW_H
#define INC_37_1_SKILLBOX_CALLERMAINWINDOW_H
...
public:
    ...
    CallerMainWindow(QMainWindow *parent = nullptr) : QMainWindow(parent) {}
...
#endif //INC_37_1_SKILLBOX_CALLERMAINWINDOW_H
